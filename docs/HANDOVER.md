...
- The conversions stay read-only. A change needs Jack's explicit
  authorization. **Two candidates are open.** The first, since 2026-09-14: the
  ...
  three cells as the scan prints them. The second, since 2026-09-14:
  the F conversion's
  ...
  with its own quote marks and an empty continuation column (M6-6). Two
  candidates closed before them. The first, opened 2026-09-13 and
  ...
  reading, corrected the same day. The second,
  ...
  **Chunk A8 closes the pass, on 2026-08-10, under the same option B.**
  ...
  Thirty-one corrections are authorized and
  applied. The most recent, on 2026-09-14, is the p. 217 note with its
  report block. The one before it, on 2026-09-06, is the `*SPEC  06`
  character on
