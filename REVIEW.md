...
6. **Convergence authorizes the merge.** When both reviewers give
   ...
   the pull request that adopted this section. A new commit voids both
   verdicts.
7. **The charter does not authorize its own amendment.** A pull
   request that adopts or changes this section, CLAUDE.md section 12,
   or the external-review skill merges only on Jack's instruction.
