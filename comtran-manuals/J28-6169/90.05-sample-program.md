...
```
        ...
        *COMPILE LIST                                             CT PUBLICATIONS
        CTC
         ...
         43,00   71252    CNTRLCHARSECLIN            02        A '2'
...
- PDF p.198, line 12 ("*SPEC 06 6"): originally transcribed "*SPEC 05" and annotated here as a keying anomaly of the 1961 listing, on the grounds that the page image at 8x zoom and the independent OCR draft both read "05". Corrected to "06" on 2026-09-06 on Jack's authorization. A 150-dpi column measurement of the scan on 2026-08-30 found that the "*FILE 06" line directly above prints the same glyph — a 6 whose top stroke is weak — so the transcriber read one glyph as 6 and its twin as 5; the scan outranks the conversion (CLAUDE.md section 9). Jack confirmed the reading by eye on 2026-09-06. The crop and the measurement are in the review record on branch review/2026-08-30-m4s3-deck-loader, item 8.
...
```
    ...
    01220  0774 00 0 00000   10000  WITHOLDING.TAX.ROUTINE
                                                AXT    0
...
```
    ...
    *CTEND             DATE 101861 TIME   2.45      CT PUBLICATIONS         67
    DONE
```
...
The illustrative run of the sample program (source listed on the preceding pages) produced the following output. Column headings were not printed by the sample program; figures are reproduced exactly as printed. The page is a skewed print: every line rises to the right by about one line height, on one straight baseline, and each line's fields are transcribed on that line's own baseline.
...
01 1010 BLUT H          10-06-61   40.0    136.00   19.80   0.00           2.00    2.00    112.20
         DEPARTMENT 01 TOTALS      40.0    136.00   19.80   0.00   0.00    2.00    2.00    112.20    0.00
02 1021 CASPERIAN J     10-06-61   20.0    106.66   16.86   3.20           3.00    3.00     80.60
         DEPARTMENT 02 TOTALS      20.0    106.66   16.86   3.20   0.00    3.00    3.00     80.60    0.00
03 1721 CATLETT H       10-06-61   31.0    217.00   36.72   0.00           3.00    3.00    174.28
         DEPARTMENT 03 TOTALS      31.0    217.00   36.72   0.00   0.00    3.00    3.00    174.28    0.00
04 1723 DORR D          10-06-61   32.5    292.50   47.97   2.01           3.00    3.00    236.52
         DEPARTMENT 04 TOTALS      32.5    292.50   47.97   2.01   0.00    3.00    3.00    236.52    0.00
06 1793 CABAN R         10-06-61   40.0     94.00   16.92   0.00           1.50    1.50     74.08
         DEPARTMENT 06 TOTALS      40.0     94.00   16.92   0.00   0.00    1.50    1.50     74.08    0.00
07 1802 SMITH B         10-06-61   30.0     87.00   13.32   0.00           1.50    1.50     70.68
07 1803 SOBEK W         10-06-61   40.0    120.00   16.92   0.00   4.00    2.00    2.00     95.08
         DEPARTMENT 07 TOTALS      70.0    207.00   30.24   0.00   4.00    3.50    3.50    165.76    0.00
09 1924 REYNOLDS J      10-06-61   40.0    399.60   69.59   0.00   5.00    3.00    3.00    319.01
09 1977 WILLIAMS P      10-06-61   37.0    369.63   59.51   0.00  10.00    3.00    3.00    294.12
09 1978 RICHARD D       10-06-61   40.0    440.00   69.84   0.00           3.00    3.00    364.16
09 1980 WOO J           10-06-61   39.0    468.00   81.90   0.00  17.00    3.00    3.00    363.10   37.50
         DEPARTMENT 09 TOTALS     156.0   1677.23  280.84   0.00  32.00   12.00   12.00   1340.39   37.50
...
CHECKFILE REPORT (partial)                          ERRORFILE REPORT
                                                     ...
                                                     M011001AJAX T
    110-06-61                 091977                M011011BLOODSOE F
    2WILLIAMS P              $294.12                 M041722DICK M
                                                     M041791SMITH J
    110-06-61                 091978                M051792JONES F
    2RICHARD D               $364.16                 D061500100661400
                                                     M071794MANDELI A
    110-06-61                 091980                M071801FUNGE T
    2WOO J                   $363.10                 D071899100661400
                                                      M081921CRAMER P
                                                      M081922BAKER B
