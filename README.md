...
| `docs/reconstruction-method.md` | How this project decides a question from thin, silent, or conflicting sources — and what the method cannot do. Written so that a person recovering a different extinct language can follow it. It describes the practice; it binds nothing. |
